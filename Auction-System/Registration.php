...
if (isset($_POST['register-button'])) {
    ...
    if (strlen($password_1)<8) {
        array_push($errors, "Sorry, your password should be at least 8 digits");
    }
    ...
    <form method="post" action="Registration.php" class="mt-3" oninput='password_2.setCustomValidity(password_2.value != password_1.value ? "Passwords do not match." : "")'>
        ...
        <div class="form-group">
            <div class="mx-auto" style="width: 300px;">
                ...
                <input type="password" class="form-control" id="InputPassword2" placeholder="Confirm Password" name="password_2" required>
